        ...
        //
            ...
            switch(sMotorState)
            {
                 ...
                 case STATE_RUNNING:
                {
                	 bReverse[1] = 0;
                	 bReverse[0] = 0;
                	 MotorDir((tSide)1, (tDirection)bReverse[1]);
                	 MotorDir((tSide)0, (tDirection)bReverse[0]);
                	 MotorSpeed((tSide)0, 50 << 8);
                	 MotorSpeed((tSide)1, 50 << 8);
                	 MotorRun((tSide)1);
                	 MotorRun((tSide)0);
               ...
               case STATE_PRAWY:
                {
                	 ...
                	 MotorDir((tSide)1, (tDirection)bReverse[1]);
                	 MotorDir((tSide)0, (tDirection)bReverse[0]);
                	 MotorSpeed((tSide)0, 60 << 8);
                	 MotorSpeed((tSide)1, 10 << 8);
                	 cofanie=0;
                     MotorRun((tSide)0);
                     MotorRun((tSide)1);
                ...
                case STATE_LEWY:
					...
					MotorDir((tSide)1, (tDirection)bReverse[1]);
					MotorDir((tSide)0, (tDirection)bReverse[0]);
					MotorSpeed((tSide)0, 10 << 8);
					MotorSpeed((tSide)1, 60 << 8);
					cofanie=0;
					MotorRun((tSide)0);
					MotorRun((tSide)1);
